  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-neutral-950">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          <p className="text-sm uppercase tracking-widest text-[#008080] mb-4 font-medium">
          ...
          >
            <a
              href="https://tcr.populiweb.com/router/admissions/onlineapplications/index?application_form=57"
              target="_blank"
          ...
          <p className="mt-6 text-sm text-white/50">
            970-874-7671 · admissions@tcr.edu
          </p>
        </motion.div>
      </div>
    </div>
